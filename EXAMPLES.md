...
The following example shows how to list at most, the 30 next accounts in the list.
...
The following example shows how to use the API to delete account's quota :
...
The following example shows how todelete an account :
...
client.
The following example shows how toto authenticate with aws signature version 2 :
