...
const IAMClient = require('./IAMClient.js');
 ...
 */
    ...
    case 'delete-user':
        return actionGen('delete-user', enteredArgs, 'delete', nextStep);
 ...
 */
    ...
    case 'delete-access-key':
        return actionGen('delete-access-key', enteredArgs, 'delete', nextStep);
/*
