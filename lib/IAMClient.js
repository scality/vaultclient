...
class VaultClient {
    ...
    _logSocketStats() {
        ...
        this._agentPool.forEach((agent, index) => {
            ...
            if (stats.totalSockets) agentStats.totalSockets += stats.totalSockets;
            if (stats.totalRequests) agentStats.totalRequests += stats.totalRequests;
            if (stats.freeSockets) agentStats.freeSockets += stats.freeSockets;
        });
