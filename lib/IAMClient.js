...
class VaultClient {
     ...
     * @returns {undefined}
     */
    updateAccountLimits(accountName, limits, callback) {
        const data = {
     ...
     * @returns {undefined}
     */
    deleteAccountLimits(accountName, callback) {
        const data = {
     ...
     * @returns {undefined}
     */
    getAccountLimits(accountName, callback) {
        const data = {
     ...
     * @returns {undefined}
     */
    getAccountLimitsByCanonicalIds(canonicalIds, options, callback) {
        this.getAccounts(null, null, canonicalIds, options, (err, res, code) => {
            ...
            const body = res.reduce((accounts, account) => {
                ...
                accounts[account.canId] = account.limits;
                return accounts;
            }, {});
    ...
    verifySignatureV2(string, signature, accessKey, options, callback) {
        ...
        if (options.targetAccount) {
            data.targetAccount = options.targetAccount;
        }
